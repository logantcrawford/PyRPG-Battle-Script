...
class Person:
    ...
    def choose_magic(self):
        i = 1
        print("\n" + bcolors.OKBLUE + bcolors.BOLD + "Magic", str(self.mp) + "/" + str(self.maxmp) + bcolors.ENDC)
    ...
    def get_enemy_stats(self):
        ...
        print(bcolors.BOLD + self.name + "    " + current_hp + " |"+ bcolors.FAIL + hp_bar + bcolors.ENDC + bcolors.BOLD + "|")
